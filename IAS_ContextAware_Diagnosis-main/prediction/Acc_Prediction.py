...
def Acc_predict():
    ...
    header = ['Acc_Value']
    outfile = open(r"C:\Users\meghn\Dropbox/Acc_prediction.csv",'w', newline="")
    ...
    #fig.write_image("D:\GraphContextServer-master\static\css/Accelerometer.png", engine="kaleido")
    fig.write_html("E:\Meg_Thesis\Thesis__\Ani\IAS_Context-master\IAS_Context-master\static\css/Accelerometer.html")
