...
This module trains LSTM module for Humidity readings.
'''
...
df.drop(columns=['Spin', 'Duration', 'Actual Duration', 'Water Hardness', 'Load Weight', 'Temperature', 'Pressure', 'Noise', 'Temperature', 'Pressure'], inplace=True)
