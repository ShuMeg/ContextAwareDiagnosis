...
This module trains LSTM module for Noise readings.
'''
import pandas as pd
import numpy as np
import keras
...
df.drop(columns=['Spin', 'Duration', 'Actual Duration', 'Water Hardness', 'Load Weight', 'Temperature', 'Humidity', 'Humidity', 'Temperature', 'Pressure'], inplace=True)
