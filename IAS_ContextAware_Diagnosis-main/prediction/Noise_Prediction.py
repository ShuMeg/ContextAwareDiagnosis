...
This module predicts future values for Noise readings.
'''
import pandas as pd
import numpy as np
import keras
...
def Noise_predict():
    ...
    # Select column with Noise as header
    close_data = df['Noise'].values
   ...
   # defines previous timesteps in order to predict the subsequent timestep
    ...
    header = ['Noise_Value']
    outfile = open(r"C:\Users\meghn\Dropbox/Noise_prediction.csv", 'w', newline="")
    ...
    #fig.write_image("D:\GraphContextServer-master\static\css/Noise.png", engine="kaleido")
    fig.write_html("E:\Meg_Thesis\Thesis__\Ani\IAS_Context-master\IAS_Context-master\static\css/Noise.html")